...
It is a Shape B app on the [`petal-sdl`](../../../integrations/petal-desktop-sdl/) integration (see
...
[agent-protocol.md](../../../integrations/petal-desktop-sdl/docs/agent-protocol.md).
