...
" ---- Keywords ----
syn keyword petalKeyword     import export as config let var set get state fn enum class return for in while do match when
...
" `...` is defined after `..` so it wins where both match.
syn match petalPipe     "\.\.\."
